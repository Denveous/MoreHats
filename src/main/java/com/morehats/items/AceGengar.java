...
public class AceGengar extends BaseHat {
    ...
    private static final String TOOLTIP = "Gengar";
    public AceGengar(Item.Properties settings) { super(settings, SCALE, HEIGHT, FORWARD, SIDE); }
    @Override
