...
public class GengarHat extends BaseHat {
    private static final float SCALE = 0.7F;
    private static final float HEIGHT = -0.2F; 
    private static final float FORWARD = 0.0F;
    private static final float SIDE = 0.0F;
    private static final String TOOLTIP = "Gengar Beanie";
    public GengarHat(Item.Properties settings) { super(settings, SCALE, HEIGHT, FORWARD, SIDE); }
    @Override
